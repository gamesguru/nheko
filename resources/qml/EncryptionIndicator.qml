...
Image {
    ...
    ToolTip.text: {
        ...
        console.log("EncryptionIndicator: trust=" + trust + ", Crypto.Verified=" + Crypto.Verified + ", Crypto.MessageUnverified=" + Crypto.MessageUnverified + ", deviceId=" + deviceId + ", encrypted=" + encrypted);
        if (!encrypted)
